...
*/
int Move(int x, int y, int z, int maxX, int maxY, int maxZ, int roomQualities[], string command)
{
    char action;
    ...
    else cout << "You ran around the room aimlessly. Never finding, and ultimately forgetting, exactly what you were searching for." << endl;
}
...
int main()
{
    ...
    */
    ...
    while (playing)
    {
        ...
        if(cmd[0] == 'm') Move(pX, pY, pZ, maxX, maxY, maxZ, dungeon[pZ][pRoom], cmd);
