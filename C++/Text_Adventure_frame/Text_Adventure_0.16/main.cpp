    ...
    for(int z_coordinate = 0; z_coordinate < maxZ; z_coordinate++)
    {
        ...
        for(int x_coordinate = maxX*(-1); x_coordinate < maxX; x_coordinate++)
        {
            ...
            for(int y_coordinate = maxY*(-1); y_coordinate < maxY; y_coordinate++)
            {
                ...
                if((roomNumber+1)%maxY == 0)
                {
                    cout << "FOUND NORTH BORDER @" << roomNumber << endl;
                    dungeon[z_coordinate][roomNumber][3] = 0; //North Door, 1 = true, 0 = false
                }
                else dungeon[z_coordinate][roomNumber][3] = 1;

                if(R#%maxY == 0)
                {
                    cout << "FOUND SOUTH BORDER @" << roomNumber << endl;
                    dungeon[z_coordinate][roomNumber][4] = 0; //South Door, 1 = true, 0 = false
                }
                ...
                else dungeon[z_coordinate][roomNumber][5] = 1; //East Door, 1 = true, 0 = false
...
topFloor = t, dungeon[n] == maxZ-1
bottomFloor = t, dungeon[n] == 0
*/
